...
function creatureSayCallback(cid, type, msg)
	...
	if(msgcontains(msg, 'visage') or msgcontains(msg, 'helmet')) then
		selfSay('Do you want me to craft a powerful helmet for you? I need 2 million gold coins and 8x old iron.', cid)
	...
	elseif(msgcontains(msg, 'armor') or msgcontains(msg, 'lorica')) then
		selfSay('Do you want me to craft a powerful armor for you? I need 2 million gold coins and 100x iron ore.', cid)
