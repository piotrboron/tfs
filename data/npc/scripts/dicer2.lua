...
local config = {
    bet = {
        min = 300, -- gold coins // 300 gp
        max = 500000,
        win = 180, -- 180% high/low
        winNum = 480, -- 480% numbers
    },

    playerPosition = Position(890, 990, 7), -- player must stay on this position to talk with npc
    dicerCounter = Position(890, 989, 7), -- counter position
}
