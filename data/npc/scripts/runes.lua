...
shopModule:addBuyableItem({'flask of rust remover'}, 9930, 100, 1, 'flask of rust remover')
...
shopModule:addBuyableItem({'ultimate mana potion'}, 26029, 610, 1, 'ultimate mana potion')
shopModule:addBuyableItem({'ultimate spirit potion'}, 26030, 610, 1, 'ultimate spirit potion')
shopModule:addBuyableItem({'supreme health potion'}, 26031, 610, 1, 'supreme health potion')
