...
maxPlayers = 0
motd = "Welcome to Mythoria.online"
...
experienceStages = {
	{ minlevel = 1, maxlevel = 8, multiplier = 59 },
	{ minlevel = 9, maxlevel = 20, multiplier = 58 },
	{ minlevel = 21, maxlevel = 50, multiplier = 56 },
	{ minlevel = 51, maxlevel = 99, multiplier = 54 },
	{ minlevel = 100, maxlevel = 199, multiplier = 45 },
	{ minlevel = 200, maxlevel = 3000, multiplier = 40 }
}
...
ownerName = "rosesandsins"
ownerEmail = ""
url = "https://entersitehere.com"
location = "France"
